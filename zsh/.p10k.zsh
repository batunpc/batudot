# Generated by Powerlevel10k configuration wizard on 2022-03-14 at 01:14 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND='%F{#11171b}'
  ...
  #typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%F{#11171b}\uE0B0'
